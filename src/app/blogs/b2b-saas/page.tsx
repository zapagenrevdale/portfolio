...
import Content from "@/components/markdowns/b2b-saas";
import { CodeCopy } from "@/components/atoms/code-copy";
import Link from "next/link";

export const metadata = {
  title:
    "Blogs | How I Built a B2B SaaS CI/CD Workflow with On-Premise Delivery",
  description: "How I Built a B2B SaaS CI/CD Workflow with On-Premise Delivery",
};
      ...
      <Card className="py-0">
        <CardHeader className="flex items-center justify-between rounded-t-lg p-3 m-0 border-b border-card-foreground">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-sm">b2b-saas.md</span>
          </div>
          <Link href="/">
